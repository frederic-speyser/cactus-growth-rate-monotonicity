(*
  ...
  Note (FR) : Lemme 2 (Section 4 de l'article) en entier, y compris sa
  veritable serie infinie, pas seulement ses briques elementaires. Etant
  donne deux familles de reels positifs (u_i) et (v_i) avec u_i <= v_i
  pour tout i, l'operateur construit a partir de u est majore point par
  point par celui construit a partir de v, pour un noyau abstrait K
  suppose seulement positif et croissant en chaque argument. La serie
  infinie est traitee via Series_le de la bibliotheque Coquelicot.
