(*
  ...
  Note (FR) : fait d'analyse generale, independant de tout contenu
  combinatoire. Si g est derivable sur un intervalle, avec g' strictement
  croissante, g(sigma) = 0 et g(tau) < 0, alors g'(sigma) < 0. Prouve par
  le theoreme des accroissements finis, par l'absurde : si g'(sigma) >= 0,
  la stricte croissance de g' forcerait g(tau) > 0, contredisant
  l'hypothese. Compile sans axiome au-dela de ceux deja standard dans la
  bibliotheque Reals de Coq.
